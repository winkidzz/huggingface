#!/usr/bin/env python3
"""
MedGemma Document Parser Examples
This script demonstrates how to use the MedGemma document parser for different types of medical documents.
"""
...
def example_lab_report():
    ...
    lab_entities = [e for e in parsed_doc.medical_entities if "lab" in e.entity_type.lower() or "result" in e.entity_type.lower()]
...
def main():
    ...
    print("🏥 MedGemma Document Parser Examples")
    print("=" * 60)
